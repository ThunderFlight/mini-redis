...
impl BlockingClient {
    ...
    /// }
    /// ```
    pub fn get(&mut self, key: &str, handler: String) -> crate::Result<Option<Bytes>> {
        self.rt.block_on(self.inner.get(key, handler))
    }
    ...
    /// }
    /// ```
    pub fn set(&mut self, key: &str, value: Bytes, handler: String) -> crate::Result<()> {
        self.rt.block_on(self.inner.set(key, value, handler))
    }
    ...
    pub fn set_expires(
        ...
        self.rt
            .block_on(self.inner.set_expires(key, value, handler, expiration))
    }
